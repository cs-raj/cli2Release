...
<!-- usage -->
```sh-session
$ npm install -g cs/cli-cm-migrate-rte
$ csdx COMMAND
running command...
$ csdx (--version)
cs/cli-cm-migrate-rte/1.4.17 darwin-arm64 node-v21.6.2
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
