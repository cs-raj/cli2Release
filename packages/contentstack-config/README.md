...
<!-- toc -->
* [contentstack-cli-1-config](#contentstackcli-config)
* [Usage](#usage)
* [Commands](#commands)
<!-- tocstop -->
...
<!-- usage -->
```sh-session
$ npm install -g contentstack-cli-1-config
$ csdx COMMAND
running command...
$ csdx (--version)
contentstack-cli-1-config/1.6.4 darwin-arm64 node-v21.6.2
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
